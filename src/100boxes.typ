...
$ P(A_2) &= P(A_1 sect A_2) + P(A'_1 sect A_2)\ &= P(A_1)P(A_2/A_1) + P(A'_1)P(A_2/A'_1)\
&= 1/100 dot 0 + 99/100 dot 1/99\ &= 1/100
$

Similarly, for $A_3$ we can write

$ P(A_3) &=&& P(A_2 sect A_3) + P(A'_2 sect A_3)\
&=&& P(A_1 sect A_2 sect A_3) + P(A'_1 sect A_2 sect A_3) + P(A_1 sect A'_2 sect A_3) +  \ &&& P(A'_1 sect A'_2 sect A_3) 
$

These are all the possibilities of $A_1$ and $A_2$, which might have occured before opening the third box. But, we can clearly see, just like the above case, here the first three terms will become 0. This is because all $A_n$ are disjoint events, and hence they cannot occur simultaneously. So any event of the type $A_i sect A_j$ will obviously become an impossible event.
...
P(A_2) &= P(A'_1 sect A_2) &&= P(A'_1)P(A_2/A'_1) &&= 99/100 dot 1/99\
P(A_3) &= P(A'_1 sect A'_2 sect A_3) &&= P(A'_1)P(A'_2/A'_1)P(A_3/(A'_1 sect A'_2)) &&= 99/100 dot 98/99 dot 1/98\
P(A_4) &=  P(A'_1 sect A'_2 sect A'_3 sect A_4) && = P(A'_1)P(A'_2/A'_1) ... P(A_4/(A'_1 sect A'_2 sect A'_3)) &&= 99/100 dot 98/99 dot 97/98 dot 1/97
$
}
...
#set box(stroke: 1pt, outset: (x: 4pt, y: 4pt), baseline: 0.65em)

$ P("Success") = frac("Favourable", "Total") &= P(A_1 union A_2 union A_3 union A_4 union ... union A_50) /  1\ & =50 times 1/100  = #box($ 1/2 $) $